...
var Knob = React4.memo(React4.forwardRef(function(inProps, ref) {
  ...
  var _useEventListener = useEventListener({
    ...
    when: enabled
  }), _useEventListener2 = _slicedToArray3(_useEventListener, 2), bindWindowMouseMoveListener = _useEventListener2[0], unbindWindowMouseMoveListener = _useEventListener2[1];
  var _useEventListener3 = useEventListener({
    ...
    when: enabled
  }), _useEventListener4 = _slicedToArray3(_useEventListener3, 2), bindWindowMouseUpListener = _useEventListener4[0], unbindWindowMouseUpListener = _useEventListener4[1];
  var _useEventListener5 = useEventListener({
    ...
    when: enabled
  }), _useEventListener6 = _slicedToArray3(_useEventListener5, 2), bindWindowTouchMoveListener = _useEventListener6[0], unbindWindowTouchMoveListener = _useEventListener6[1];
  var _useEventListener7 = useEventListener({
    ...
    when: enabled
  }), _useEventListener8 = _slicedToArray3(_useEventListener7, 2), bindWindowTouchEndListener = _useEventListener8[0], unbindWindowTouchEndListener = _useEventListener8[1];
  ...
  var text = props.showValue && React4.createElement("text", labelProps, valueToDisplay());
  ...
  return React4.createElement("div", rootProps, React4.createElement("svg", svgProps, React4.createElement("path", rangeProps), React4.createElement("path", valueProps), text));
}));
